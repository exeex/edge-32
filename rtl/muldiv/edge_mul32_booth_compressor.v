...
*/
(* keep_hierarchy = "yes" *)
module edge_mul32_booth_compressor #(
  parameter MULT_SUB_FIXED_ZERO = 1'b0
) (
  clk,
  reset_n,
  in_valid,
...
reg     [65:0]  stage1_s0_0;
reg     [65:0]  stage1_s0_1;
reg     [65:0]  stage1_s0_2;
reg     [65:0]  stage1_s0_3;
reg     [65:0]  stage1_s0_4;
reg     [65:0]  stage1_s0_5;
reg     [65:0]  stage1_c0_0;
reg     [65:0]  stage1_c0_1;
reg     [65:0]  stage1_c0_2;
reg     [65:0]  stage1_c0_3;
reg     [65:0]  stage1_c0_4;
reg     [65:0]  stage1_c0_5;
reg     [2:0]   valid_pipe;
wire    [68:0]  result_0_next;
wire    [68:0]  result_1_next;
...
wire effective_mult_sub = MULT_SUB_FIXED_ZERO ? 1'b0 : mult_sub;

assign mult_src[SRC1_WIDTH-1:0] = effective_mult_sub ?
                                   ~multiplier[SRC1_WIDTH-1:0] :
                                   multiplier[SRC1_WIDTH-1:0];

assign data_for_code[SRC1_WIDTH+1:0] = {mult_src[SRC1_WIDTH-1],mult_src[SRC1_WIDTH-1:0],1'b0};

assign data_for_acc[DST_WIDTH-1:0] = effective_mult_sub ?
                                    {{SRC1_WIDTH{multiplicand[SRC0_WIDTH-1]}},multiplicand[SRC0_WIDTH-1:0]} :
                                     {DST_WIDTH{1'b0}};

// &Instance("edge_mul32_booth_code_33", "x_pa_dsp_mult_edge_mul32_booth_code_330"); @37
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_330 (
  .A                   (multiplicand[32:0] ),
...
// &Instance("edge_mul32_booth_code_33",   "x_pa_dsp_mult_edge_mul32_booth_code_331"); @44
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_331 (
  .A                   (multiplicand[32:0] ),
...
// &Instance("edge_mul32_booth_code_33", "x_pa_dsp_mult_edge_mul32_booth_code_332"); @51
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_332 (
  .A                   (multiplicand[32:0] ),
...
// &Instance("edge_mul32_booth_code_33", "x_pa_dsp_mult_edge_mul32_booth_code_333"); @58
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_333 (
  .A                   (multiplicand[32:0] ),
...
// &Instance("edge_mul32_booth_code_33", "x_pa_dsp_mult_edge_mul32_booth_code_334"); @65
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_334 (
  .A                   (multiplicand[32:0] ),
...
// &Instance("edge_mul32_booth_code_33", "x_pa_dsp_mult_edge_mul32_booth_code_335"); @72
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_335 (
  .A                    (multiplicand[32:0]  ),
...
// &Instance("edge_mul32_booth_code_33", "x_pa_dsp_mult_edge_mul32_booth_code_336"); @79
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_336 (
  .A                    (multiplicand[32:0]  ),
...
// &Instance("edge_mul32_booth_code_33", "x_pa_dsp_mult_edge_mul32_booth_code_337"); @86
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_337 (
  .A                    (multiplicand[32:0]  ),
...
// &Instance("edge_mul32_booth_code_33", "x_pa_dsp_mult_edge_mul32_booth_code_338"); @93
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_338 (
  .A                    (multiplicand[32:0]  ),
...
// &Instance("edge_mul32_booth_code_33", "x_pa_dsp_mult_edge_mul32_booth_code_339"); @100
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_339 (
  .A                    (multiplicand[32:0]  ),
...
// &Instance("edge_mul32_booth_code_33", "x_pa_dsp_mult_edge_mul32_booth_code_3310"); @107
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_3310 (
  .A                    (multiplicand[32:0]  ),
...
// &Instance("edge_mul32_booth_code_33",   "x_pa_dsp_mult_edge_mul32_booth_code_3311"); @114
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_3311 (
  .A                    (multiplicand[32:0]  ),
...
// &Instance("edge_mul32_booth_code_33", "x_pa_dsp_mult_edge_mul32_booth_code_3312"); @121
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_3312 (
  .A                    (multiplicand[32:0]  ),
...
// &Instance("edge_mul32_booth_code_33", "x_pa_dsp_mult_edge_mul32_booth_code_3313"); @128
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_3313 (
  .A                    (multiplicand[32:0]  ),
...
// &Instance("edge_mul32_booth_code_33", "x_pa_dsp_mult_edge_mul32_booth_code_3314"); @135
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_3314 (
  .A                    (multiplicand[32:0]  ),
...
// &Instance("edge_mul32_booth_code_33", "x_pa_dsp_mult_edge_mul32_booth_code_3315"); @142
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_3315 (
  .A                    (multiplicand[32:0]  ),
...
// &Instance("edge_mul32_booth_code_33", "x_pa_dsp_mult_edge_mul32_booth_code_3316"); @149
edge_mul32_booth_code_33  x_pa_dsp_mult_edge_mul32_booth_code_3316 (
  .A                    (multiplicand[32:0]  ),
...
//=============================================================================
assign ex1_p1_0_0[DST_WIDTH-1:0] = stage1_s0_0[DST_WIDTH-1:0];
assign ex1_p1_0_1[DST_WIDTH-1:0] ={stage1_c0_0[DST_WIDTH-2:0],1'b0};
assign ex1_p1_0_2[DST_WIDTH-1:0] = stage1_s0_1[DST_WIDTH-1:0];
assign ex1_p1_0_3[DST_WIDTH-1:0] ={stage1_c0_1[DST_WIDTH-2:0],1'b0};

assign ex1_p1_1_0[DST_WIDTH-1:0] = stage1_s0_2[DST_WIDTH-1:0];
assign ex1_p1_1_1[DST_WIDTH-1:0] ={stage1_c0_2[DST_WIDTH-2:0],1'b0};
assign ex1_p1_1_2[DST_WIDTH-1:0] = stage1_s0_3[DST_WIDTH-1:0];
assign ex1_p1_1_3[DST_WIDTH-1:0] ={stage1_c0_3[DST_WIDTH-2:0],1'b0};

assign ex1_p1_2_0[DST_WIDTH-1:0] = stage1_s0_4[DST_WIDTH-1:0];
assign ex1_p1_2_1[DST_WIDTH-1:0] ={stage1_c0_4[DST_WIDTH-2:0],1'b0};
assign ex1_p1_2_2[DST_WIDTH-1:0] = stage1_s0_5[DST_WIDTH-1:0];
assign ex1_p1_2_3[DST_WIDTH-1:0] ={stage1_c0_5[DST_WIDTH-2:0],1'b0};
...
assign result_0_next[DST_WIDTH+2:0] ={ex2_s3_0[DST_WIDTH+1],ex2_s3_0[DST_WIDTH+1:0]};
assign result_1_next[DST_WIDTH+2:0] ={ex2_c3_0[DST_WIDTH+1],ex2_c3_0[DST_WIDTH:0],1'b0};
assign out_valid = valid_pipe[2];

// Only validity is reset.  Datapath state is ignored until its matching valid
// bit arrives, avoiding a chip-wide asynchronous reset load on wide registers.
...
// Real compressor boundaries.  Each stage accepts a new operation every cycle.
always @(posedge clk) begin
  result_0 <= result_0_next;
  result_1 <= result_1_next;
  stage1_s0_0 <= ex1_s0_0;
  stage1_s0_1 <= ex1_s0_1;
  stage1_s0_2 <= ex1_s0_2;
  stage1_s0_3 <= ex1_s0_3;
  stage1_s0_4 <= ex1_s0_4;
  stage1_s0_5 <= ex1_s0_5;
  stage1_c0_0 <= ex1_c0_0;
  stage1_c0_1 <= ex1_c0_1;
  stage1_c0_2 <= ex1_c0_2;
  stage1_c0_3 <= ex1_c0_3;
  stage1_c0_4 <= ex1_c0_4;
  stage1_c0_5 <= ex1_c0_5;

  ex2_p2_0_0 <= ex1_p2_0_0;
  ex2_p2_0_1 <= ex1_p2_0_1;
  ex2_p2_0_2 <= ex1_p2_0_2;
  ex2_p2_1_0 <= ex1_p2_1_0;
  ex2_p2_1_1 <= ex1_p2_1_1;
  ex2_p2_1_2 <= ex1_p2_1_2;
end
